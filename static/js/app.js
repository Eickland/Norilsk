    ...
    createDynamicEditForm(probe, probeId) {
        ...
        const fieldCategories = {
            ...
            'Характеристики пробы': ['is_solid', 'is_solution', 'sample_mass', 'V (ml)', 'Масса навески (g)', 'Разбавление','pH','Eh','Плотность',
                'Масса твердого (g)','Объем р-ра Ca(OH)2 (ml)','Объем р-ра CaCO3 (ml)','Плотность','Объем р-ра H2SO4 (ml)','Масса железных окатышей (g)'],
        ...
        const fieldTypes = {
            ...
            'number': ['Ca', 'Fe', 'Ni', 'Cu', 'Co', 'dCa', 'dFe', 'dNi', 'dCu', 'dCo', 
                      ...
                      'Масса твердого (g)','Объем р-ра Ca(OH)2 (ml)','Объем р-ра CaCO3 (ml)','Объем р-ра H2SO4 (ml)','Масса железных окатышей (g)'],
            'textarea': ['описание'],
            'select': ['status_id'],
        };
