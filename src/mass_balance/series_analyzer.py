...
FIELD_VALIDATION_CONFIG = {
    'start_A': {
        ...
        'Разбавление': {'min': 1, 'max': 2000, 'warning': 'Разбавление вне нормы'},
    },
    'start_B': {
    ...
    'st2_A': {
        'V (ml)': {'min': 50, 'max': 300, 'warning': 'Объем вне нормы'},
        'Разбавление': {'min': 1, 'max': 2000, 'warning': 'Разбавление вне нормы'},        
    },
    'st2_B': {
        'sample_mass': {'min': 10, 'max': 150, 'warning': 'Масса вне оптимального диапазона'},
    },
    'st2_C': {
        'sample_mass': {'min': 21, 'max': 400, 'warning': 'Масса вне оптимального диапазона'},
        'V (ml)': {'min': 50, 'max': 300, 'warning': 'Объем вне нормы'},
    },
    'st3_A': {
        'V (ml)': {'min': 50, 'max': 600, 'warning': 'Объем вне нормы'},
        'Разбавление': {'min': 1, 'max': 2000, 'warning': 'Разбавление вне нормы'},
        
    },
    'st3_B': {
        'sample_mass': {'min': 10, 'max': 400, 'warning': 'Масса вне оптимального диапазона'},
    },
    'st3_C': {
        'sample_mass': {'min': 21, 'max': 600, 'warning': 'Масса вне оптимального диапазона'},
        'V (ml)': {'min': 50, 'max': 700, 'warning': 'Объем вне нормы'},
    },
    'st4_A': {
        'V (ml)': {'min': 50, 'max': 600, 'warning': 'Объем вне нормы'},
        'Разбавление': {'min': 1, 'max': 2000, 'warning': 'Разбавление вне нормы'},
    ...
    'st4_B': {
        'sample_mass': {'min': 10, 'max': 200, 'warning': 'Масса вне оптимального диапазона'},
    },
    'st4_D': {
        'sample_mass': {'min': 1, 'max': 200, 'warning': 'Масса вне оптимального диапазона'},
    },
    'st4_C': {
        'V (ml)': {'min': 50, 'max': 700, 'warning': 'Объем вне нормы'}
    },
    'start_B': {
        'sample_mass': {'min': 10, 'max': 300, 'warning': 'Масса вне оптимального диапазона'},
    },
    'st6_E': {
        'sample_mass': {'min': 21, 'max': 500, 'warning': 'Масса вне оптимального диапазона'},
    },
    'st6_G': {
        'V (ml)': {'min': 50, 'max': 800, 'warning': 'Объем вне нормы'},
        'Разбавление': {'min': 1, 'max': 2000, 'warning': 'Разбавление вне нормы'},
